...
public class XOperatorSet extends OperatorSet {
	...
	private void annotateOperators(OperatorSet o) {
		...
		OP_UDIVIDE =  new XOperator("UDivide","^-1",null,XOperator.UNARY+XOperator.RIGHT+XOperator.PREFIX+XOperator.SELF_INVERSE+XOperator.NOT_IN_PARSER);
	
		OP_POWER  = new XOperator(o.getPower(),XOperator.BINARY+XOperator.RIGHT);
		...
		OP_LIST = new XOperator(o.getList(),XOperator.NARY+XOperator.RIGHT+XOperator.NOT_IN_PARSER); // 
		OP_ELEMENT = new XOperator(o.getElement(),XOperator.NARY+XOperator.RIGHT+XOperator.NOT_IN_PARSER); // 
